...
with st.form("form", clear_on_submit=False):
    ...
    main_camera = st.radio('main_camera', main_cameras, horizontal=True, index=None)
    front_camera = st.radio('front_camera', front_cameras, horizontal=True, index=None)
    display = st.radio('display', displays, horizontal=True, index=None)
